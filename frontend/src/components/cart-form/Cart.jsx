                            ...
                            <div className='flex flex-col justify-between items-start w-2/3 space-y-10 x-full'>
                                <div className="flex justify-between items-inline w-full">
                                    ...
                                    <div className="flex flex-col justify-between items-start">
                                        <p className="text-md text-purple-900 font-bold">Quantity</p>
                                        <div className="flex items-center space-x-3 mt-3">
                                            <button className="text-black font-bold py-2 px-4 rounded-full border border-black border-opacity-50 text-sm" onClick={handleDecrease}>
                                                -
                                            </button>
                                            <p className="text-lg font-semibold mr-2">{count}</p>
                                            <button className="text-black font-bold py-2 px-4 rounded-full border border-black border-opacity-50 text-sm" onClick={handleIncrease}>
                                                +
                                            </button>
                                        </div>
                                    </div>
