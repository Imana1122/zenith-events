    ...
    <>
      <div className="flex flex-col justify-start md:border md:border-slate-500 p-5 md:rounded-lg h-fit md:w-1/2">
        ...
        <Link
          ...
          className={` md:hidden bg-purple-900 text-white py-2 rounded flex items-center justify-center w-fit h-fit px-5 ${!isAgreed ? 'pointer-events-none opacity-50' : ''}`}
        >
          Checkout
        </Link>
        <button

          className={`hidden md:flex bg-purple-900 text-white py-2 rounded items-center justify-center w-fit h-fit px-5 ${!isAgreed ? 'pointer-events-none opacity-50' : ''}`}
        >
          Checkout
        </button>
      </div>
